 ...
 * Description: This is a widget to display Galleries
 * Author: Victor Tihai
 * Version: 1.1.2
...
class wplook_gallery_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'WPlook Gallery',
			array( 'description' => __( 'A widget for displaying latest Gallery', 'wplook' ), )
		);
	}
	...
	public function form( $instance ) {
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('nr_posts'); ?>"> <?php _e('Number of Gallery:', 'wplook'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('Number of galleries you want to display', 'wplook'); ?></p>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('read_more_link'); ?>"> <?php _e('URL to all Gallery:', 'wplook'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('View all galleries URL', 'wplook'); ?></p>
			</p>
	...
	public function widget( $args, $instance ) {
		...
		?>
			...
			<?php if( $gallery->have_posts() ) : ?>
				...
				<aside class="widget WPlookGallery">	
					<div class="widget-title">
						<h3><?php echo $title ?></h3>
						<?php if ( $read_more_link != "") { ?>
							<div class="viewall fright"><a href="<?php echo $read_more_link; ?>" class="radius" title="<?php _e('View all Galleries', 'wplook'); ?>"><?php _e('view all', 'wplook'); ?></a></div>
						<?php } ?>
