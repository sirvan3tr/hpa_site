 ...
 * Description: This is a widget to display Publications
 * Author: Victor Tihai
 * Version: 1.1.2
 * Author URI: http://www.wplook.com
*/

add_action('widgets_init', create_function('', 'return register_widget("wplook_publications_widget");'));
class wplook_publications_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'wplook_publications_widget',
			'WPlook Publications',
			array( 'description' => __( 'A widget for displaying latest Publications', 'wplook' ), )
		);
	}
	...
	public function form( $instance ) {
		...
		?>
			...
			<p>
				...
				<?php wp_dropdown_categories(
					array( 
						...
						'show_count'	=> 1,
						'selected' => $categories,
						'taxonomy'  => 'wpl_publications_category' 
					) 
				); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('nr_posts'); ?>"> <?php _e('Number of Publications:', 'wplook'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('Number of publications you want to display', 'wplook'); ?></p>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('read_more_link'); ?>"> <?php _e('URL to all Publications:', 'wplook'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('View all publications URL', 'wplook'); ?></p>
			</p>
				...
				<aside class="widget WPlookPublications">	
					<div class="widget-title">
						...
						<?php if ( $read_more_link != "") { ?>
							<div class="viewall fright"><a href="<?php echo $read_more_link; ?>" class="radius" title="<?php _e('View all Publications', 'wplook'); ?>"><?php _e('view all', 'wplook'); ?></a></div>
						<?php } ?>
