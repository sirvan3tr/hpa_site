...
add_action('widgets_init', create_function('', 'return register_widget("wplook_projects_widget");'));
class wplook_projects_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'wplook_projects_widget',
			'WPlook Projects',
			array( 'description' => __( 'A widget for displaying Projects', 'wplook' ), )
		);
	}
	...
	public function form( $instance ) {
		...
		?>
			...
			<p>
				...
				<?php wp_dropdown_categories(
					array( 
						...
						'show_count'	=> 1,
						'selected' => $categories,
						'taxonomy'  => 'wpl_projects_category' 
					) 
				); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('nr_posts'); ?>"> <?php _e('Number of projects:', 'wplook'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('Number of projects you want to display', 'wplook'); ?></p>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('read_more_link'); ?>"> <?php _e('URL to all projects:', 'wplook'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('View all projects URL', 'wplook'); ?></p>
			</p>
				...
				<aside class="widget WPlookProjects">	
					<div class="widget-title">
						...
						<?php if ( $read_more_link != "") { ?>
							<div class="viewall fright"><a href="<?php echo $read_more_link; ?>" class="radius" title="<?php _e('View all projects', 'wplook'); ?>"><?php _e('view all', 'wplook'); ?></a></div>
						<?php } ?>
